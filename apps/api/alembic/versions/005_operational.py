...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("company_id", "ingestion_id", name="uq_evidences_company_ingestion"),
    )
    op.create_index("ix_evidences_company_id", "evidences", ["company_id"])
    op.create_index(
        "ix_evidences_tenant_camera_captured",
        "evidences",
        ["company_id", "camera_id", "captured_at"],
    )
    ...
    op.create_index("ix_decision_evidences_company_id", "decision_evidences", ["company_id"])
    ...
    op.create_index("ix_audit_records_company_id", "audit_records", ["company_id"])
    ...
    op.create_index("ix_notification_configs_company_id", "notification_configs", ["company_id"])
    ...
    op.create_index(
        "ix_notification_deliveries_company_id", "notification_deliveries", ["company_id"]
    )
