...
from argus.domain.models import Decision, Evidence, Lens  # noqa: E402
...
from argus.services.database import dispose_engine, tenant_session  # noqa: E402
...
async def clean_open_decision():
    key = f"decision:open:{SEED_TENANT_ID}:{SEED_CAMERA_ID}:{SEED_REGION_ID}"
